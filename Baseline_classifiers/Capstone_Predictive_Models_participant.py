...
turn_diarisation_annotation_participant = pd.read_csv('./data/turn_participant_for_model.csv')

train, test = train_test_split(turn_diarisation_annotation_participant, test_size=0.2, random_state=11)
print(train.shape)
print(test.shape)
...
NB_transcription.to_csv('./performance/participant_NB_transcription.csv', index=False)

NB_nostopwords = NBclassifier(train['transcription_NoStopWords'], train['label'], test['transcription_NoStopWords'], test['label'])
NB_nostopwords.to_csv('./performance/participant_NB_nonstopwrods.csv', index=False)
...
print(NB_lemma)
NB_lemma.to_csv('./performance/participant_NB_lemma.csv', index=False)
...
print(NB_nostopwords_lemma)
NB_nostopwords_lemma.to_csv('./performance/participant_NB_nostopwords_lemma.csv', index=False)
...
print(SVM_transcription)
SVM_transcription.to_csv('./performance/participant_SVM_transcription.csv', index=False)

SVM_transcription_L2 = SVMclassifier(train['transcription'], train['label'], test['transcription'], test['label'],'l2')
SVM_transcription_L2.to_csv('./performance/participant_SVM_transcription_L2.csv', index=False)

SVM_nostopwords = SVMclassifier(train['transcription_NoStopWords'], train['label'], test['transcription_NoStopWords'], test['label'], 'none')
SVM_nostopwords.to_csv('./performance/participant_SVM_nonstopwrods.csv', index=False)
...
SVM_nostopwords_L2.to_csv('./performance/participant_SVM_nonstopwrods_L2.csv', index=False)
...
SVM_lemma.to_csv('./performance/participant_SVM_lemma.csv', index=False)
...
SVM_lemma_L2.to_csv('./performance/participant_SVM_lemma_L2.csv', index=False)
...
SVM_nostopwords_lemma.to_csv('./performance/participant_SVM_nostopwords_lemma.csv', index=False)
...
SVM_nostopwords_lemma_L2.to_csv('./performance/participant_SVM_nostopwords_lemma_L2.csv', index=False)
...
LR_lemma.to_csv('./performance/participant_LR_lemma.csv', index=False)
...
LR_lemma_L2.to_csv('./performance/participant_LR_lemma_L2.csv', index=False)
...
LR_nostopwords_lemma.to_csv('./performance/participant_LR_nostopwords_lemma.csv', index=False)
...
LR_nostopwords_lemma_L2.to_csv('./performance/participant_LR_nostopwords_lemma_L2.csv', index=False)
